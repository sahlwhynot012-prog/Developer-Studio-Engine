...
import { SceneObject, CameraMode } from '../types';
        ...
        <div className="h-full flex flex-col">
            <div className="p-4 space-y-4 overflow-y-auto">
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500 font-mono">ID: {selectedObject.id}</p>
                </div>
                ...
                { (selectedObject.type === 'DirectionalLight' || selectedObject.type === 'PointLight') && (
                     <div className="bg-black/20 p-3 rounded-lg space-y-3">
                        ...
                        {/* FIX: Called onUpdateObject directly for type-specific 'intensity' property to resolve type error. */}
                ...
                { selectedObject.type === 'ViewPort' && (
                     <div className="bg-black/20 p-3 rounded-lg space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {/* FIX: Called onUpdateObject directly for type-specific 'mode' property to resolve type error. */}
                        ...
                        {/* FIX: Called onUpdateObject directly for type-specific 'zoom' property to resolve type error. */}
